...
export class SuggestedChangeNode extends ViewNode<'suggested-change', DraftsView> {
	constructor(
		uri: GitUri,
		view: DraftsView,
		...
		super('suggested-change', uri, view, parent);
	...
	getTreeItem(): TreeItem {
		const label = this.draft.title ?? `Suggsted Change (${this.draft.id})`;
